...
def plot_opt_csi_and_divt(paths, sub_fig_csi_opt, sub_fig_divt_opt, marker_size=2.0):
    ...
    sub_fig_csi_opt.set_ylim([-0.1, 1.1])
    sub_fig_csi_opt.set_yticks([0.0, 0.5, 1.0])
    ...
    sub_fig_divt_opt.set_ylim([0.0, 0.016])
...
def plot_opt_fit(paths, csi, divt, sub_fig_csi_opt_fit, sub_fig_divt_opt_fit, scattersize=10.0):
    ...
    deviations = []
    csi_fits = [0.76, 0.71, 0.65, 0.75, 0.74, 0.78, 0.61, 0.65, 0.65, 0.71]
...
def plot_scr_fit(all_paths, scr_csi, scr_divt, sub_fig_csi_scr_fit, sub_fig_divt_scr_fit, scattersize=10.0):
    ...
    csi_fits = [
        [0.7, 0.65, 0.69, 0.4, 0.6, 0.57],
        [0.3, 0.45, 0.36, 0.37, 0.27, 0.29],
        [0.2, 0.32]
    ]
    divt_fits = [
        [0.78, 0.65, 0.73, 0.55, 0.63, 0.66],
        [0.37, 0.52, 0.47, 0.48, 0.3, 0.25],
        [0.25, 0.3]
    ]
